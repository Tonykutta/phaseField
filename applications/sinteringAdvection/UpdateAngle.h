...
void customPDE<dim,degree>::UpdateAngle() const {
...
for (int i=0;i<3;i++){
omega[i]= mR/customPDE::mVolume1*T1[i]*180/M_PI;
//omega2[i]= mR/customPDE::mVolume2*T2_rot[i];
}
Angle[0]=omega[2]*userInputs.dtValue+AngleOld1[0];
customPDE::mAngleX1=Angle[0];
customPDE::mAngleY1=Angle[1];
customPDE::mAngleZ1=Angle[2];


for (int i=0;i<3;i++){
omega[i]= mR/customPDE::mVolume2*T2[i]*180/M_PI;
//omega2[i]= mR/customPDE::mVolume2*T2_rot[i];
}
Angle[0]=omega[2]*userInputs.dtValue+AngleOld2[0];
customPDE::mAngleX2=Angle[0];
customPDE::mAngleY2=Angle[1];
customPDE::mAngleZ2=Angle[2];

for (int i=0;i<3;i++){
omega[i]= mR/customPDE::mVolume3*T3[i]*180/M_PI;
//omega2[i]= mR/customPDE::mVolume2*T2_rot[i];
}
Angle[0]=omega[2]*userInputs.dtValue+AngleOld3[0];
customPDE::mAngleX3=Angle[0];
customPDE::mAngleY3=Angle[1];
customPDE::mAngleZ3=Angle[2];
