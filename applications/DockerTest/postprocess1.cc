...
void variableAttributeLoader::loadPostProcessorVariableAttributes(){
	...
	set_dependencies_value_term_RHS(0, "c, grad(c),grad(n1),grad(n2),grad(mu),grad(c),n2,mu,n1,n3,grad(n3),n4,grad(n4),n5,grad(n5),n6,grad(n6),n7,grad(n7),n8,grad(n8),n9,grad(n9),n10,grad(n10),n11,grad(n11),n12,grad(n12)");
	set_dependencies_gradient_term_RHS(0, "");
	set_output_integral         	(0,true);

int numin=12;
unsigned int var_index=0, var_indexa, var_indexb, var_indexc, var_indexd;
	for ( var_index=1; var_index<=numin; var_index++){
	  ...
	  set_variable_type				(var_index,SCALAR);
	 	set_dependencies_value_term_RHS(var_index, "c, grad(c),grad(n1),grad(n2),grad(mu),grad(c),n2,mu,n1,n3,grad(n3),n4,grad(n4),n5,grad(n5),n6,grad(n6),n7,grad(n7),n8,grad(n8),n9,grad(n9),n10,grad(n10),n11,grad(n11),n12,grad(n12)");
...
for ( var_indexa=1; var_indexa<=3; var_indexa++){
	...
	set_dependencies_value_term_RHS(var_indexa+numin, "c, grad(c),grad(n1),grad(n2),grad(mu),grad(c),n2,mu,n1,n3,grad(n3),n4,grad(n4),n5,grad(n5),n6,grad(n6),n7,grad(n7),n8,grad(n8),n9,grad(n9),n10,grad(n10),n11,grad(n11),n12,grad(n12)");
...
for ( var_indexb=1; var_indexb<=3; var_indexb++){
	...
	set_dependencies_value_term_RHS(var_indexb+numin*2, "c, grad(c),grad(n1),grad(n2),grad(mu),grad(c),n2,mu,n1,n3,grad(n3),n4,grad(n4),n5,grad(n5),n6,grad(n6),n7,grad(n7),n8,grad(n8),n9,grad(n9),n10,grad(n10),n11,grad(n11),n12,grad(n12)");
...
for ( var_indexc=1; var_indexc<=numin; var_indexc++){
	...
	set_dependencies_value_term_RHS(var_indexc+numin*3, "c, grad(c),grad(n1),grad(n2),grad(mu),grad(c),n2,mu,n1,n3,grad(n3),n4,grad(n4),n5,grad(n5),n6,grad(n6),n7,grad(n7),n8,grad(n8),n9,grad(n9),n10,grad(n10),n11,grad(n11),n12,grad(n12)");
...
for ( var_indexd=1; var_indexd<=numin; var_indexd++){
	...
	set_dependencies_value_term_RHS(var_indexd+numin*4, "c, grad(c),grad(n1),grad(n2),grad(mu),grad(c),n2,mu,n1,n3,grad(n3),n4,grad(n4),n5,grad(n5),n6,grad(n6),n7,grad(n7),n8,grad(n8),n9,grad(n9),n10,grad(n10),n11,grad(n11),n12,grad(n12)");
