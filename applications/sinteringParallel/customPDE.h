    ...
    void nonExplicitEquationRHS(variableContainer<dim,degree,dealii::VectorizedArray<double> > & variable_list,
      ...
      void equationLHS(variableContainer<dim,degree,dealii::VectorizedArray<double> > & variable_list,
        ...
        public:
          ...
          void rotation(std::vector<double> &Angle, std::vector<double> &RotationVector, std::vector<double> &Tensor, std::vector<double> &TensorRot) const;//  void anisotropygb(const dealii::Tensor<1, dim, dealii::VectorizedArray<double> > & anisonorm,

          void rotation1(std::vector<double> &Angle, std::vector<double> &RotationVector) const;//  void anisotropygb(const dealii::Tensor<1, dim, dealii::VectorizedArray<double> > & anisonorm,
        ...
        //void  computeVolume(const std::vector<vectorType*> variableSet,double &Volume, int index) const;
        // void  hallo(double& integratedField, int index, const std::vector<vectorType*> variableSet) const;
        //   void  Intfield(double& integratedField, int index, const std::vector<vectorType*> variableSet) const;

        //     			 dealii::VectorizedArray<double> & gammagb,
        //     			 dealii::Tensor<1, dim, dealii::VectorizedArray<double> > & normal1,
        //         dealii::Tensor<1, dim, dealii::VectorizedArray<double> > & normal2) const;
        // ================================================================
